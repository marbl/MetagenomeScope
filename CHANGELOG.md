...
- Related to the above change: flatten child edges of very simple types of
  bubbles and frayed ropes.
  ...
  - Long story short, the default way the graph is drawn should generally look
    good ...
