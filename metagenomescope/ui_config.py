...
DEFAULT_USE_NODE_LABELS = True
DEFAULT_USE_EDGE_LABELS = False
DEFAULT_LABELS = []
if DEFAULT_USE_NODE_LABELS:
    DEFAULT_LABELS.append(NODE_LABELS)
if DEFAULT_USE_EDGE_LABELS:
    DEFAULT_LABELS.append(EDGE_LABELS)
