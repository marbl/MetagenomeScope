...
LABEL_OFFSET = "offsetlbls"
LABEL_OUTLINE = "outlinelbls"
LABEL_AUTOROTATE_EDGE = "autorotedgelbls"
DEFAULT_NODE_LABEL_SETTINGS = []
DEFAULT_EDGE_LABEL_SETTINGS = [LABEL_OFFSET]
DEFAULT_PATTERN_LABEL_SETTINGS = []
