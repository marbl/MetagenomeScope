...
Furthermore, `path_of_edges.gfa` and `path_of_edges_multigraph.gfa` are modified versions of
...
`flye_yeast_assembly_info.txt` and `flye_yeast_noseq.gfa` were downloaded from the same repository.
(For reference, I removed sequences from the GFA file using
[this gist](https://gist.github.com/fedarko/1a98cc0641b75e4dc5314b46f1d5993a).)
