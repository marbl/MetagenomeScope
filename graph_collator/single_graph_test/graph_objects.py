...
class Node(object):
    ...
    """
    def __init__(self, id_string, bp, is_complement, single_node=False,
            depth=None, gc_content=None, dna_fwd=None):
        ...
        # If True, we use the "single" node style (indicating no orientation)
