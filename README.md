...
| [FASTG](https://github.com/fedarko/pyfastg#the-fastg-file-format) (`.fastg`) | [SPAdes](https://github.com/ablab/spades), [MEGAHIT](https://github.com/voutcn/megahit) | Expects FASTG files [produced by](https://github.com/fedarko/pyfastg) SPAdes or MEGAHIT. |
